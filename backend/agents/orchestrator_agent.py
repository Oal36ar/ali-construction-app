...
def get_llm(model_name: str = "google/gemini-2.5-flash", **kwargs) -> Union[OpenRouterLLM, OpenAILLM]:
    ...
    if "google" in model_lower or "mistral" in model_lower or "openrouter" in model_lower:
        ...
        if not api_key:
            print("⚠️ OPENROUTER_API_KEY not found, using default")
            api_key = "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"
        ...
        if not OPENAI_AVAILABLE:
            ...
            api_key = os.getenv("OPENROUTER_API_KEY", "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")
            return OpenRouterLLM(
                api_key=api_key,
                text_model=model_name,
                temperature=kwargs.get('temperature', 0.3),
